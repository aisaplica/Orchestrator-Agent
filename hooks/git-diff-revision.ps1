...
.EXAMPLE
    .\git-diff-revision.ps1 "C:\Desarrollo\SVN\ScacsWeb\Ingenieros\src\trunk" "a1b2c3d"
    .\git-diff-revision.ps1 "C:\Desarrollo\SVN\ScacsWeb\Ingenieros\src\trunk" "a1b2c3d,e4f5a6b"
#>
param(
...
function Get-RevisionInfo([string]$workspace, [string]$rev) {
    ...
    # Diff del commit: "git show <rev>" trae metadatos + diff
